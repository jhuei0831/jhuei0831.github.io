...
2. If you want to use [gulp.js](https://gulpjs.com/) run `gulp` or `npm start`
...
title: Getting Started # title of your post
featured-img: jhuei #optional - if you want you can include hero image
---
```
...
Jhuei uses [Lazy Sizes](https://github.com/aFarkas/lazysizes). Lazy Loader for loading images. Check the link for more info. Lazy Sizes doesnt’t require any configuration and it’s going to be included in your bundled js file.
...
Jhuei comes with [`jekyll-seo-tag`](https://github.com/jekyll/jekyll-seo-tag) plugin preinstalled to make sure your website gets the most useful meta tags. See [usage](https://github.com/jekyll/jekyll-seo-tag/blob/master/docs/usage.md) to know how to set it up.
...
This project is base on `jekyll-sleek`.
